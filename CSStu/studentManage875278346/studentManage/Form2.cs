...
namespace studentManage
{
    ...
    /*    private void 确定_Click(object sender, EventArgs e)
        ...
        {
            FileStream fs = new FileStream("C:\\Users\\Administrator\\Desktop\\studentManage\\studentManage\\listDate.txt", FileMode.Create, FileAccess.Write);
            StreamWriter sw = new StreamWriter(fs);
            //sw.Write(textBox1.Text);
            sw.WriteLine(textName.Text + "----" + comboSex.Text + "----" + textID.Text + "----" +
                textMajor.Text + "----" + textGrade.Text + "----" + textIntake.Text + "----" + textBirth.Text +
        ...
        internal DataGridViewTextBoxColumn ResetStudent()
        {
