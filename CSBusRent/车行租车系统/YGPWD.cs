...
namespace 车行租车系统
{
    public partial class YGPWD : Form
    {
        public YGPWD()
        {
            InitializeComponent();
            ...
            if (this.textBox1.Text == UserInfo.getUserPWD)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string SQL = "update TB_User set PWD='" + this.textBox2.Text + "' where UserName='" + UserInfo.getUserName + "'";
        ...
        private void YGPWD_Load(object sender, EventArgs e)
        {
