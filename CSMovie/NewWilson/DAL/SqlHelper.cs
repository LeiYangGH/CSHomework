...
namespace DAL
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static readonly string ConnString =
            ConfigurationManager.ConnectionStrings["yp_conn"].ConnectionString;
        ...
        /// <param name="cmdText">sql语句/参数化sql语句/存储过程名</param>
        ...
        public static int ExecuteNonQuery(string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] cmdParams)
        {
            ...
            {
                PrepareCommand(cmd, cmdType,conn, cmdText, cmdParams);
                int val = cmd.ExecuteNonQuery();

                return val;
            }
        }
        /// <summary>带事务的sql 命令</summary>
        public static int ExecuteNonQuery(SqlTransaction tran,CommandType cmdType, string cmdText, params SqlParameter[] cmdParams)
        {
            SqlCommand cmd = new SqlCommand();
            PrepareCommand(cmd, tran.Connection, tran, cmdType, cmdText, cmdParams);
            int val = cmd.ExecuteNonQuery();
        ...
        public static SqlDataReader ExecuteReader(string connectionString, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand();
                PrepareCommand(cmd, cmdType, conn, cmdText, commandParameters);
        ...
        private static void PrepareCommand(SqlCommand cmd, CommandType cmdType, SqlConnection conn, string cmdText, SqlParameter[] cmdParms)
        {
            //打开连接
        ...
        private static void PrepareCommand(SqlCommand cmd,SqlConnection conn, SqlTransaction tran, CommandType cmdType,string cmdText, SqlParameter [] sqlParms)
        {
            if (conn.State != ConnectionState.Open)
                conn.Open();
            cmd.Connection = conn;
